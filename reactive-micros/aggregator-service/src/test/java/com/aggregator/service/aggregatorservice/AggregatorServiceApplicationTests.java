...
abstract class AggregatorServiceApplicationTests {

  protected static final Path TEST_RESOURCE_PATH = Path.of("src/test/resources");
  ...
  protected String resourceToString(String relativePath){
      try {
          return Files.readString(TEST_RESOURCE_PATH.resolve(relativePath));
      } catch (IOException e) {
